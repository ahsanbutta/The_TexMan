/**
 * 43 — PROFESSIONAL RESUME
 * American-style standard 1-page/2-page executive resume format with achievement-driven bullets and clean line separators.
 * 100% ATS Friendly.
 */
export default function Template43_FreshGraduateMinimal({ cv }) {
  return (
    <div className="w-full bg-white text-zinc-900 font-sans text-[11px] leading-normal select-text min-h-[1050px] p-8 sm:p-9 text-left">
      <div className="text-center border-b-2 border-black pb-3 mb-4">
        <h1 className="text-2xl font-bold uppercase tracking-tight text-black">{cv.fullName}</h1>
      ...
      <div className="space-y-3.5">
        ...
        <div className="pt-2 border-t border-black flex justify-between text-[9.5px] text-zinc-600">
