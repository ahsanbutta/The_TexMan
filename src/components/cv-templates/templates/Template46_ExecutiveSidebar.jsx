/**
 * 46 — ATS FINANCE
 * Finance & Audit-specialized ATS format for accounting, treasury, and compliance applications.
 * 100% ATS Friendly.
 */
export default function Template46_ExecutiveSidebar({ cv }) {
  return (
    <div className="w-full bg-white text-black font-sans text-[11px] leading-normal select-text min-h-[1050px] p-8 sm:p-10 text-left">
      <div className="pb-3 border-b border-black mb-4">
        ...
        <div className="text-xs font-semibold text-gray-800 mt-0.5">
          {[cv.ftsBatch, cv.crn, cv.targetRole || 'Senior Accountant & Financial Controller'].filter(Boolean).join(' | ')}
        </div>
